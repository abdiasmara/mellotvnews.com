...
import { Globe, Newspaper, Share2, Shield, UserCheck, Tv, Clock, Sparkles } from 'lucide-react';
      ...
      <div className="bg-slate-900/90 border-b border-slate-800/80 px-4 py-1.5 text-xs text-slate-400">
        <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-2 ml-auto">
            {userRole === 'admin' ? (
              <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-amber-500/20 border border-amber-500/50 text-amber-300 font-semibold text-[11px]">
            ...
            <button
              ...
              className="px-2.5 py-0.5 rounded bg-slate-800 hover:bg-slate-700 border border-slate-700 text-slate-200 text-[11px] font-medium transition-colors"
            >
              {userRole === 'admin' ? 'Keluar Admin' : 'Login Admin'}
            </button>
          </div>
        </div>
      </div>
